...
/**
 * Wichtiger Hinweis:
 * Ich habe diesen Code vermurkst. Ich wollte nur mal eben nen NTP-Client
 * haben und daher den Code angepasst und vermurkst.
 */
...
public class NtpMessage
{
	...
	public String toString()
	{
		...
		return "";//timestampToString(transmitTimestamp);
	}
	 ...
	 */
	public static int[] timestampToString(double timestamp)
	{
		...
		// Originalen Code hier geändert.
		// Hier wird primitiv, unprofessionell und ineffizient das 
		// Integer-Array zusammengebaut.
		String Stunden = new SimpleDateFormat("HH").format(new Date(ms));
		String Minuten = new SimpleDateFormat("mm").format(new Date(ms));
		String Sekunden = new SimpleDateFormat("ss").format(new Date(ms));
		
		int[] zeit = {
				Integer.valueOf(Stunden).intValue(),
				Integer.valueOf(Minuten).intValue(),
				Integer.valueOf(Sekunden).intValue()
				};
		...
		return zeit;//date + fractionSting;
	}
